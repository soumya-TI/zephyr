 ...
 *
 * Runs the vendored LVGL "motor control" UI (see ui/, provenance in README.rst)
...
int main(void)
{
	...
	/* Build the motor control UI (subjects, screens, logic + simulator) and
	 * load the run screen. Assets are compiled in, so the asset-path

...
lv_obj_t * chip_create(lv_obj_t * parent, lv_style_t * tone, lv_style_t * tone_dot, lv_style_t * tone_text, const char * text, bool hide_dot)
{
    ...
    if (ti_thermostat_check_target(TI_THERMOSTAT_TARGET_ALL)) {
        ...
        lv_obj_set_name_static(card_0, "chip_#");
        ...
        lv_obj_set_flag(card_1, LV_OBJ_FLAG_HIDDEN, hide_dot);

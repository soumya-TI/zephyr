...
lv_obj_t * mode_pill_heat_create(lv_obj_t * parent)
{
    ...
    if (ti_thermostat_check_target(TI_THERMOSTAT_TARGET_ALL)) {
        ...
        lv_obj_set_name_static(lv_button_0, "mode_pill_heat_#");
        ...
        lv_obj_add_style(lv_button_0, &style_mode_on_heat, LV_STATE_CHECKED);
        lv_obj_add_subject_set_int_event(lv_button_0, &subject_mode, LV_EVENT_CLICKED, REF_MODE_HEAT);
        lv_obj_bind_state_if_eq(lv_button_0, &subject_mode, LV_STATE_CHECKED, REF_MODE_HEAT);
        lv_obj_t * lv_image_0 = lv_image_create(lv_button_0);
        lv_image_set_src(lv_image_0, icon_flame);
        lv_obj_set_flag(lv_image_0, LV_OBJ_FLAG_CLICKABLE, false);
        lv_obj_add_style(lv_image_0, &style_icon, 0);
        lv_obj_add_style(lv_image_0, &style_icon_heat, LV_STATE_CHECKED);

        lv_obj_t * label_0 = label_create(lv_button_0);
        lv_label_set_text(label_0, "Heat");
        ...
        lv_obj_add_style(label_0, &style_mode_label_heat, LV_STATE_CHECKED);
